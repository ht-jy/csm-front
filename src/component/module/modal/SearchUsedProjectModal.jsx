...
/**
 * @description: 공사관리에서 사용하고 있는 프로젝트를 선택할 수 있는 모달
 * 
 * @author 작성자: 정지영
 ...
 * @additionalInfo
 * - API: 
 *    Http Method - GET : /project (공사관리 프로젝트 조회)
 */

const SearchUsedProjectModal = ({isOpen, fncExit, onClickRow}) => {
...
export default SearchUsedProjectModal;